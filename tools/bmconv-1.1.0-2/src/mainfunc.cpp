...
static int check_compiler(void)
{
	...
	const unsigned long base = (unsigned long)&hdr.bfType;
	const unsigned long offs = (unsigned long)&hdr.bfSize;
	const unsigned long res1 = (unsigned long)&hdr.bfReserved1;
