...
ARGS="-nocompress -sid 0x00000000 -uid1 0x10000079 -uid2 0x00000000 -uid3 0x00000000 -vid 0x00000000 -capability none -fpu softvfp -version 4.2 $INPUT -allowdlldata"
